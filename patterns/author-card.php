...
', 'spaceblock' ) ?>" class=" wp-image-1908" width="171" height="256" /></figure>
      ...
      <div class="wp-block-column" style="flex-basis:80%">
        ...
        <h3 class="has-text-color has-base-font-size" style="color:#979797">Darrell Steward</h3>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"textColor":"quaternary","fontSize":"md"} -->
        <p class="has-quaternary-color has-text-color has-md-font-size" style="font-style:normal;font-weight:700">
          Twitter specialist. Zombie enthusiast. Tv fanatic. Lifelong gamer. Food geek. Wannabe travel nerd. Pop culture
          evangelist.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:column -->
      ...
      <div class="wp-block-column" style="flex-basis:20%">
        ...
        <div class="wp-block-buttons">
          <!-- wp:button -->
          <div class="wp-block-button"><a class="wp-block-button__link" href="#">View Author</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
